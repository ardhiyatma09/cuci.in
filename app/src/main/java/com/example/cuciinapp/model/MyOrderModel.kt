...
class MyOrderModel {
    ...
    constructor()
    constructor(
        id_transaksi: Long, id_laundri: Long, id_user: String, nama_laundri: String, status: String,
    ...
    fun getId_transaksi(): Long? {
        return id_transaksi
    }

    fun getId_laundri(): Long? {
        return id_laundri
    }
    ...
    fun setId_transaksi(id_transaksi: Long) {
        this.id_transaksi = id_transaksi
    }

    fun setId_laundri(id_laundri: Long) {
        this.id_laundri = id_laundri
    }
    ...
    fun setNama_laundri(nama_laundri: String) {
        this.nama_laundri = nama_laundri
    }
